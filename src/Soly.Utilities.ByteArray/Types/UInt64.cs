...
public partial class ByteArray
{
    ...
    {
        this.WriteU64(value, this.position, this.Endianness);
        this.position += 8;
    }
    public void WriteU64(ulong value, int position)
    {
        this.WriteU64(value, position, this.Endianness);
    }
    public void WriteU64(ulong value, Endianness endianness)
    {
        this.WriteU64(value, this.position, endianness);
        this.position += 8;
    }
    public void WriteU64(ulong value, int position, Endianness endianness)
    {
        if (endianness == Endianness.BE)
        {
